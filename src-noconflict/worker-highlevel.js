...
ace.define("ace/mode/highlevel/jshint",["require","exports","module"], function(require, exports, module) {
...
var JSHINT = (function() {
  ...
  var api, // Extension API
    ...
    functionicity = [
    "float","int","boolean","ItemPosition",
      "Agent"
    ],
...
Lexer.prototype = {
  ...
  scanKeyword: function() {
    ...
    var keywords = [
      ...
      "eff","pre","float","int","boolean","ItemPosition",
      "Agent","MW","Init","exit","shared","atomic","SW",
      "finally", "extends", "function", "continue",
      "debugger", "instanceof"
    ];   // line for scanKeyword !!!!!!
...
ace.define("ace/mode/highlevel_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror","ace/mode/highlevel/jshint"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var lint = require("./highlevel/jshint").JSHINT;
...
var highlevelWorker = exports.highlevelWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(500);
    this.setOptions();
};

oop.inherits(highlevelWorker, Mirror);
...
}).call(highlevelWorker.prototype);
